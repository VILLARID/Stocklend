    ...
    return (
        <div className="flex flex-col bg-white w-full h-full rounded-xl p-4 shadow-sm gap-5">
            ...
            <div className="flex flex-col gap-2">
                <h2 className="font-semibold text-xl">Actividad reciente</h2>
                <p className="text-gray-400 text-sm">Últimos movimientos del sistema</p>
            </div>
            ...
            <div className="flex flex-col gap-8">
                ...
                {mockData.map((item, index) => {
                    const isReturn = item.name.toLowerCase().includes("devolución");
                    ...
                    return (
                        <div key={index} className="flex items-center justify-between">
                            ...
                            <div className="flex gap-3 items-center">
                                <div className={`w-12 h-12 rounded-xl ${isReturn ? "bg-green-200" : "bg-blue-200"}`}></div>
